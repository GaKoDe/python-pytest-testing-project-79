...
def test_download_html_with_files(tmp_path):
    ...
    image_path = str(tmp_path / 'ru-hexlet-io-courses_files/ru-hexlet-io-assets-professions-python.png')
    image_content = get_file_bytes(get_file_fixture_name('python.png'))

    css_link_url = 'https://ru.hexlet.io/assets/application.css'
    css_link_path = str(tmp_path / 'ru-hexlet-io-courses_files/ru-hexlet-io-assets-application.css')
    css_link_content = get_file_bytes(get_file_fixture_name('application.css'))

    html_link_url = 'https://ru.hexlet.io/courses'
    html_link_path = str(tmp_path / 'ru-hexlet-io-courses_files/ru-hexlet-io-courses.html')
    html_link_content = get_file_bytes(get_file_fixture_name('html-with-files.html'))

    script_url = 'https://ru.hexlet.io/packs/js/runtime.js'
    script_path = str(tmp_path / 'ru-hexlet-io-courses_files/ru-hexlet-io-packs-js-runtime.js')
